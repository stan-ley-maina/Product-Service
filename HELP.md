...
* The original package name 'com.example.microservices.product-service' is invalid and this project uses 'com.example.microservices.product_service' instead.
